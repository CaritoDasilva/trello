...
function drawCard() {
  ...
  homeworkDiv.innerHTML = `<div class="card" style="width: 18rem;"> <div class = "card-body" id="listAdded"><h5 class = "card-title">${titleList}</h5><a href="#" class="list-group-item list-group-item-light" id="addCard" onclick="handlerDrawCard()">+ Añade una tarjeta</a>`;
...
function agregarTarjetaClick(event) {
  const titulo = event.target.parent.getElementsByName('cardPlus')[0].value;
  agregarTarjeta(titulo);
}
